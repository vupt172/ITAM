...
namespace ITAM.Infrastructure.Migrations
{
    ...
    [Migration("20260921002715_ViTriTaiSan-IsSystem")]
    partial class ViTriTaiSanIsSystem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ITAM.Domain.Entities.DieuChuyen", b =>
                {
                    ...
                    b.HasOne("ITAM.Domain.Entities.PhongBan", "PhongBanChuyenDen")
                        .WithMany()
                        .HasForeignKey("PhongBanChuyenDenId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ITAM.Domain.Entities.PhongBan", "PhongBanChuyenDi")
                        .WithMany()
            ...
            modelBuilder.Entity("ITAM.Domain.Entities.DieuChuyenChiTiet", b =>
                {
                    ...
                    b.HasOne("ITAM.Domain.Entities.ViTriTaiSan", "ViTriChuyenDen")
                        .WithMany()
                        .HasForeignKey("ViTriChuyenDenId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ITAM.Domain.Entities.ViTriTaiSan", "ViTriChuyenDi")
                        .WithMany()
